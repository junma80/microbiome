...
usage:
   run_alpha_diversity_pipeline_ARG.rb -f projecttest1/QIIME_result/ -o projecttest/ -c '#8b0000,#000000,#0066FF,#00FF33,#66CDAA,#FF69B4,#FF8C00,#808000,#A9A9A9' -r '0,0.25,0.5,1,2,4,8,Inf' -p 2 -b T -n right -k 0 -y 6 -l -2 -g 40 -h 8 -w 8 -i F -m SampleType -j 200 
