...
#         col4+=samplehash["sequence_not_match_proximal_primer"].to_i
         lengthtrim=samplehash["sequence_length_shorter_then_min_after_trimming"].to_i
         qualtrim=samplehash["sequence_qual_lower_then_min"].to_i
...
poshash["sequence_length_shorter_then_min_after_trimming"]=6
poshash["sequence_qual_lower_then_min"]=7
...
metadata.each{|meta|    
   ...
   metasheet.row(0).push 'metalabel','Average_read_length','total_sequence_counts_match_barcode_proximal_primer','total_sequence_counts_after_quality_filter','sequence_length_shorter_then_min_after_trimming','sequence_qual_lower_then_min','sequence_hasN_filtered',"total_number_of_bases"
   ...
   metanamehash.each{|metaname,samplearray|
     ...
     samplearray.each{|samplename|
         ...
         metasheethash[4]+=stathash[samplename]["sequence_length_shorter_then_min_after_trimming"].to_i
         metasheethash[5]+=stathash[samplename]["sequence_qual_lower_then_min"].to_i
